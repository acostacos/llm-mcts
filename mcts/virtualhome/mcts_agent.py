...
class mcts_vh_env:
    def __init__(self, graph, goal_spec, task_goal, env_task_set):
        super().__init__()
...
def find_test_data_file_path(args):
    file_path = f'./vh/dataset/env_task_set_1_{args.mode}_'
...
def test():
    ...
    env = mcts_vh_env(graph, goal_spec, vhenv.task_goal, env_task_set)
    print(goal_spec)
