...
# ------------------ Smaller test data ----------------------
python vh/data_gene/gen_data/vh_init.py --display 0 --port "8083" --task all --mode simple --usage train --num-per-apartment 1
python vh/data_gene/gen_data/vh_init.py --display 0 --port "8083" --task all --mode full --usage train --num-per-apartment 1
python vh/data_gene/gen_data/vh_init.py --display 0 --port "8083" --task all --mode simple --usage train --num-per-apartment 3
python vh/data_gene/gen_data/vh_init.py --display 0 --port "8083" --task all --mode full --usage train --num-per-apartment 3
